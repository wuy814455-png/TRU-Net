...
class SimpleRes34_Unet(nn.Module):
    def __init__(self, inputchannel=6, outputchannel=1, BN_enable=True, resnet_pretrain=True, output_size=(161, 161)):
        super().__init__()
        self.BN_enable = BN_enable
        ...
        self.firstconv = nn.Conv2d(in_channels=inputchannel, out_channels=64, kernel_size=7, stride=1, padding=3,
                                   bias=False)
        ...
        if resnet_pretrain:
            ...
            print(f"SimpleRes34_Unet: ResNet34 pretrained weights loaded, adapted for {inputchannel} channels.")
